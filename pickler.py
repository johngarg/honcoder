...
if __name__ == '__main__':
    download_honcode_database(args.path) if args.path is not None else download_honcode_database()
    pickle_honcode_database(args.path) if args.path is not None else pickle_honcode_database()
